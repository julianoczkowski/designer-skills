...
7. Design Review     → Critique and refine
```

## Rules

1. **At the start**, tell the designer what the full sequence looks like and ask if they want to skip any phases. Common skip patterns:
   ...
   - Quick build without formal review → skip design-review
...
**Transition**: "Build is complete. Ready for a design review against the brief?"

### Phase 7: Design Review
Read the `design-review` skill (design-review/SKILL.md) and follow its instructions.
**Produces**: `DESIGN_REVIEW.md` in the project root, or direct feedback.
**Transition**: "Review is done. If there are must-fix items, I can address them now. Otherwise, the flow is complete."
